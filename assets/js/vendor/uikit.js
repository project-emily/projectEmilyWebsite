/*! UIkit 3.0.0-rc.25 | https://www.getuikit.com | (c) 2014 - 2018 YOOtheme | MIT License */
...
(function (global, factory) {
  ...
  var pointerDown = !hasTouch
    ? "mousedown"
    : "mousedown " + (hasTouchEvents ? "touchstart" : "pointerdown");
  var pointerMove = !hasTouch
    ? "mousemove"
    : "mousemove " + (hasTouchEvents ? "touchmove" : "pointermove");
  var pointerUp = !hasTouch
    ? "mouseup"
    : "mouseup " + (hasTouchEvents ? "touchend" : "pointerup");
  var pointerEnter =
    hasTouch && hasPointerEvents ? "pointerenter" : "mouseenter";
  var pointerLeave =
    hasTouch && hasPointerEvents ? "pointerleave" : "mouseleave";
      ...
      updates.forEach(function (ref, i) {
        ...
        if (read && !includes(fastdom.reads, reads[i])) {
          reads[i] = fastdom.read(function () {
            var result =
              this$1._connected && read.call(this$1, this$1._data, e);
  ...
  function stateAPI(UIkit) {
    ...
    UIkit.prototype._initObserver = function () {
      ...
      this._observer.observe(el, {
        attributes: true,
        attributeFilter: filter$$1.concat(
          filter$$1.map(function (key) {
            return "data-" + key;
          })
        ),
      });
    ...
    methods: {
      ...
      _toggle: function (el, toggled) {
        ...
        if (this.cls) {
          changed =
            includes(this.cls, " ") ||
            Boolean(toggled) !== hasClass(el, this.cls);
          changed &&
            toggleClass(
              el,
              this.cls,
  ...
  var Video = {
    ...
    update: {
      read: function (_, ref) {
        ...
        return !this.player ||
          ((type === "scroll" || type === "resize") && !this.inView)
          ? false
          : {
              visible:
...

          {
            write: function () {
              ...
              this.elements.forEach(function (el) {
                ...
                if (
                  height$$1 &&
                  (this$1.forceHeight || Math.round(height$$1) >= height(el))
                ) {
  ...
  function parseSymbols(svg, icon) {
    if (!symbols[svg]) {
      ...
      while ((match = symbolRe.exec(svg))) {
        symbols[svg][match[3]] =
          '<svg xmlns="https://www.w3.org/2000/svg"' + match[1] + "svg>";
      }
  ...
  var closeIcon =
    '<svg width="14" height="14" viewBox="0 0 14 14" xmlns="https://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>';

  var closeLarge =
    '<svg width="20" height="20" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>';

  var marker =
    '<svg width="20" height="20" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>';

  var navbarToggleIcon =
    '<svg width="20" height="20" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg"><rect y="9" width="20" height="2"/><rect y="3" width="20" height="2"/><rect y="15" width="20" height="2"/></svg>';

  var overlayIcon =
    '<svg width="40" height="40" viewBox="0 0 40 40" xmlns="https://www.w3.org/2000/svg"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>';

  var paginationNext =
    '<svg width="7" height="12" viewBox="0 0 7 12" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>';

  var paginationPrevious =
    '<svg width="7" height="12" viewBox="0 0 7 12" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>';

  var searchIcon =
    '<svg width="20" height="20" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>';

  var searchLarge =
    '<svg width="40" height="40" viewBox="0 0 40 40" xmlns="https://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>';

  var searchNavbar =
    '<svg width="24" height="24" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>';

  var slidenavNext =
    '<svg width="14px" height="24px" viewBox="0 0 14 24" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "/></svg>';

  var slidenavNextLarge =
    '<svg width="25px" height="40px" viewBox="0 0 25 40" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5 "/></svg>';

  var slidenavPrevious =
    '<svg width="14px" height="24px" viewBox="0 0 14 24" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23 "/></svg>';

  var slidenavPreviousLarge =
    '<svg width="25px" height="40px" viewBox="0 0 25 40" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547 "/></svg>';

  var spinner =
    '<svg width="30" height="30" viewBox="0 0 30 30" xmlns="https://www.w3.org/2000/svg"><circle fill="none" stroke="#000" cx="15" cy="15" r="14"/></svg>';

  var totop =
    '<svg width="18" height="10" viewBox="0 0 18 10" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 "/></svg>';
  ...
  var Img = {
    ...
    update: {
      read: function (ref) {
        ...
        return {
          image: getImage(this.dataSrc, this.dataSrcset, this.sizes).then(
            function (img) {
  ...
  function getPlaceholderImage(width$$1, height$$1, sizes) {
    ...
    return (
      'data:image/svg+xml;utf8,<svg xmlns="https://www.w3.org/2000/svg" width="' +
      width$$1 +
      '" height="' +
      height$$1 +
      '"></svg>'
  ...
  var Switcher = {
    ...
    update: function () {
      ...
      this.show(
        filter(this.toggles, "." + this.cls)[0] ||
    ...
    methods: {
      ...
      show: function (item) {
        ...
        if (
          !toggle ||
          (prev >= 0 && hasClass(toggle, this.cls)) ||
          prev === next
        ) {
          return;
        }
    ...
    events: [
...

      {
        ...
        handler: function (e) {
          ...
          var link;
          if (
            closest(e.target, 'a[href="#"], button') ||
  ...
  var Filter = {
    ...
    update: function (data$$1) {
      ...
      if (
        isEqualList(toggles, this.toggles, false) &&
        isEqualList(children, this.target.children, false)
      ) {
        return;
      }
  ...
  function matchFilter(el, attr$$1, ref) {
    ...
    return (
      (isUndefined(filter$$1) ||
        (group in stateFilter && filter$$1 === stateFilter[group])) &&
      ...
      startAutoplay: function () {
        ...
        if (this.autoplay && !this.userInteracted) {
          this.interval = setInterval(function () {
            return (
              !(this$1.isHovering && this$1.pauseOnHover) &&
              !this$1.stack.length &&
              this$1.show("next")
            );
    ...
    methods: {
      ...
      move: function (e) {
        ...
        while (nextIndex !== prevIndex && dis > width$$1) {
          ...
          width$$1 =
            this$1._getDistance(prevIndex, nextIndex) ||
            slides[prevIndex].offsetWidth;
        }
  ...
  var SliderNav = {
    ...
    update: {
      write: function () {
        ...
        toggleClass(
          $$(this.navItemSelector, this.$el).concat(this.nav),
          "uk-hidden",
          !this.maxIndex
        );
  ...
  var Slider = {
    ...
    methods: {
      ...
      getIndex: function (index$$1, prev) {
        ...
        return clamp(
          getIndex(index$$1, this.slides, prev, this.finite),
          0,
          this.maxIndex
        );
      },
    ...
    events: [
...

      {
        ...
        handler: function (_, item) {
          ...
          if (
            type === "image" ||
            source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)
          ) {
            ...
            (matches$$1 = source.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/))
          ) {
            ajax(
              ...
              function (ref) {
                ...
                return this$1.setItem(
                  item,
                  getIframe(
                    "https://player.vimeo.com/video/" + matches$$1[2],
                    width$$1,
                    height$$1,
                    this$1.videoAutoplay
                  )
          ...
          this.$create(
            ...
            assign({}, this.$props, {
              items: this.toggles.reduce(function (items, el) {
                items.push(
                  ["href", "caption", "type", "poster", "alt"].reduce(function (
                    obj,
                    attr$$1
                  ) {
                    obj[attr$$1 === "href" ? "source" : attr$$1] = data(
                      el,
                      attr$$1
                    );
                    return obj;
    ...
    created: function () {
      if (!containers[this.pos]) {
        containers[this.pos] = append(
          this.$container,
          '<div class="uk-notification uk-notification-' + this.pos + '"></div>'
        );
      }
        ...
        return Object.keys(props).reduce(
          function (css$$1, prop) {
            ...
            switch (prop) {
              ...
              case "bgy":
              case "bgx":
                css$$1["background-position-" + prop[2]] =
                  "calc(" + pos + " + " + (value + unit) + ")";
                break;
            ...
            if (slideRight > left) {
              ...
              if (!includes(sets, i)) {
                ...
                if (
                  ...
                  sets.push(i);
                  left =
                    slideLeft + width$$1 + (this$1.center ? slideWidth / 2 : 0);
                }
              }
            }
        ...
        $$(
          ...
          this$1.maxIndex &&
            toggleClass(
              ...
              "uk-hidden",
              isNumeric(index$$1) &&
                ((this$1.sets && !includes(this$1.sets, toFloat(index$$1))) ||
                  index$$1 > this$1.maxIndex)
            );
        });
      },
  ...
  var Sortable = {
    ...
    update: {
      write: function () {
        ...
        css(
          this.handle ? $$(this.handle, this.$el) : this.$el.children,
          "touchAction",
          "none"
        );
        ...
        if (top > 0 && top < this.scrollY) {
          ...
          bottom < height(document) &&
          bottom > height(window) + this.scrollY
        ) {
          scroll = this.scrollY + 5;
        }
  ...
  function isPredecessor(element, target) {
    return (
      element.parentNode === target.parentNode && index(element) > index(target)
    );
  }
  ...
  var Tooltip = {
    ...
    methods: {
      ...
      hide: function () {
        ...
        if (
          !~index$$1 ||
          (matches(this.$el, "input") && this.$el === document.activeElement)
        ) {
          return;
        }
    ...
    events:
      ((obj$1 = {}),
      (obj$1["focus " + pointerEnter + " " + pointerDown] = function (e) {
