...
(function (global, factory) {
  ...
  // Inspired by https://paulbourke.net/geometry/pointlineplane/
      ...
      this._observer = new MutationObserver(function (records) {
        ...
        if (
          records.some(function (ref) {
            ...
            return (prop === this$1.$name
              ? attrs
              : [camelize(prop), camelize(attributeName)]
            ).some(function (prop) {
              return (
                !isUndefined(data[prop]) && data[prop] !== this$1.$props[prop]
              );
            });
          })
        ) {
  ...
  var Togglable = {
    ...
    methods: {
      ...
      _toggleElement: function (el, show, animate) {
        ...
        var promise = (isFunction(animate)
          ? animate
    ...
    update: [
...

      {
        ...
        write: function (data, type) {
          ...
          if (
            scroll < 0 ||
            (scroll === lastScroll && type === "scroll") ||
            (this.showOnUp && type !== "scroll" && !this.isFixed)
          ) {
            return;
          }
    ...
    methods: {
      ...
      show: function (item) {
        ...
        this.connects.forEach(function (ref) {
          ...
          return this$1
            .toggleElement(
              toNodes(children).filter(function (child, i) {
    ...
    methods: {
      animate: function (action, target) {
        ...
        propsFrom = propsTo.map(function (props, i) {
          var from =
            children$1[i].parentNode === target
            ...
            if (slideRight > left) {
              ...
              if (!includes(sets, i)) {
                ...
                if (
                  ...
                  sets.push(i);
                  left =
                    slideLeft + width + (this$1.center ? slideWidth / 2 : 0);
                }
              }
            }
